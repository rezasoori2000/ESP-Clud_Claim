    ...
    return (
        <div >
            ...
            <Card >
                ...
                <CardHeader title="General Settings" subheader="Job Claim section settings " avatar={<Avatar aria-label="recipe" style={{ backgroundColor:'blue' }}> G </Avatar>
                } />
                <CardContent>
                    <Grid container spacing={3}>
                        <Grid item lg={6}   >
                            <ESPSelect disabled name='Factories' label='Default Factory' helptext='Name of default Factory' items={props.adminSettings.Factories} onPropertyChange={props.onSelectChange} />
            ...
            <hr />
            <Card >
                <CardHeader title="Production Board" subheader="Production Board Section Settings" avatar={<Avatar aria-label="recipe" style={{ backgroundColor: 'blue' }}> P </Avatar>
                } />
                <CardContent>
                    <Grid container spacing={3}>
                        <Grid item lg={6}   >
            ...
            <hr />
            <Card >
                <CardHeader title="Performance Statistics" subheader="Performance Statistics Section Settings" avatar={<Avatar aria-label="recipe" style={{ backgroundColor: 'blue'  }}> S </Avatar>
                } />
                <CardContent>
                    <Grid container spacing={3}>
                        <Grid item lg={6}>
